...
export default function WordMark() {
    return (
        ...
        <path d="M11.3389 6.99993L44.0433 74.3661L50.5925 79.4232L56.9138 81.6382L62.9046 82.9892L67.5661 81.7453L71.7281 79.6358L74.3629 78.1133L76.5921 74.6934L44.6486 7.33491L11.3389 6.99993Z" fill="url(#paint1_linear_3_21)"/>
        <path d="M11.3389 6.99993L44.0433 74.3661L50.5925 79.4232L56.9138 81.6382L62.9046 82.9892L67.5661 81.7453L71.7281 79.6358L74.3629 78.1133L76.5921 74.6934L44.6486 7.33491L11.3389 6.99993Z" stroke="#BB86FC"/>
        </g>
        ...
        <path d="M161.981 95.0825L111.489 71.599L111.802 95.7739L162.302 119.823C165.438 123.292 163.591 125.755 161.127 128.317C186.428 112.079 170.295 100.285 161.981 95.0825Z" fill="#BB86FC" stroke="#BB86FC"/>
        <g filter="url(#filter3_d_3_21)">
        <path d="M110.787 96.3597L162.042 73.2472L166.029 68.3223L167.893 63.4751L169.104 58.8549L168.337 55.1793L166.909 51.8623L165.865 49.756L163.396 47.8989L112.173 70.4189L110.787 96.3597Z" fill="#BB86FC"/>
        <path d="M110.787 96.3597L162.042 73.2472L166.029 68.3223L167.893 63.4751L169.104 58.8549L168.337 55.1793L166.909 51.8623L165.865 49.756L163.396 47.8989L112.173 70.4189L110.787 96.3597Z" fill="url(#paint3_linear_3_21)"/>
        <path d="M110.787 96.3597L162.042 73.2472L166.029 68.3223L167.893 63.4751L169.104 58.8549L168.337 55.1793L166.909 51.8623L165.865 49.756L163.396 47.8989L112.173 70.4189L110.787 96.3597Z" stroke="#BB86FC"/>
        </g>
